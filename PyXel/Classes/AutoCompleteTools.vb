    ...
    Public Shared Sub LoadDefaultItems(menu As AutocompleteMenu, lang As MainForm.Languages)
        ...
        Select Case lang
            ...
            Case MainForm.Languages.HTML
                snippets = {"<html>" + vbNewLine + "^" + vbNewLine + "</html>", "<head>" + vbNewLine + "^" + vbNewLine + "</head>", "<body>" + vbNewLine + "^" + vbNewLine + "</body>", "<div>" + vbNewLine + "^" + vbNewLine + "</dvi>", "<p>" + vbNewLine + "^" + vbNewLine + "</p>", "<meta>^</meta>", "<title>^</title>", "<h1>^</h1>", "<h2>^</h2>", "<h3>^</h3>", "<h4>^</h4>", "<h5>^</h5>", "<h6>^</h6>", "<b>^</b>", "<i>^</i>", "<script>" + vbNewLine + "^" + vbNewLine + "</script>"}
        End Select
